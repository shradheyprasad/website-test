...
# ============================================================================
# PIER PROFILES SUMMARY - Individual Plots
# ============================================================================
...
system_cost_file <- "system_cost/pier-system_cost.csv"
load_data_file <- "emissions/pier-emissions.csv"
emissions_file <- "emissions/pier-emissions.csv"
clean_energy_file <- "clean_energy/pier-clean_energy.csv"
scen_labels_file <- "../labels/pier-scenario_labels.csv"
...
cat("Creating Plot A: Total System Cost...\n")
...
saveWidget(
  fig_a,
  paste0(output_dir, "cost_plots/pier_plot_a.html"),
  selfcontained = TRUE
)
...
saveWidget(
  fig_b,
  paste0(output_dir, "cost_plots/pier_plot_b.html"),
  selfcontained = TRUE
)

# Plot C: Carbon Emissions
cat("Creating Plot C: Carbon Emissions...\n")
...
saveWidget(
  fig_c,
  paste0(output_dir, "cost_plots/pier_plot_c.html"),
  selfcontained = TRUE
)

# Plot D: Carbon Intensity
cat("Creating Plot D: Carbon Intensity...\n")
...
saveWidget(
  fig_d,
  paste0(output_dir, "cost_plots/pier_plot_d.html"),
  selfcontained = TRUE
)

# Plot E: Clean Energy
cat("Creating Plot E: Clean Energy...\n")
...
saveWidget(
  fig_e,
  paste0(output_dir, "cost_plots/pier_plot_e.html"),
  selfcontained = TRUE
)
