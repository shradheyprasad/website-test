...
# ============================================================================
# TECHNOLOGY PROFILES SUMMARY - Individual Plots
# ============================================================================
...
create_clean_energy_plot <- function(
  ...
  fig <- fig %>%
    layout(
      ...
      plot_bgcolor = "white",
      paper_bgcolor = "white",
      margin = list(l = 80, r = 80, t = 60, b = 80), # Increased right margin for legend
      showlegend = legend # Changed to use the legend parameter
    )
...
saveWidget(
  fig_a,
  paste0(output_dir, "cost_plots/tech_plot_a.html"),
  selfcontained = TRUE
)
...
saveWidget(
  fig_c,
  paste0(output_dir, "cost_plots/tech_plot_c.html"),
  selfcontained = TRUE
)
...
saveWidget(
  fig_d,
  paste0(output_dir, "cost_plots/tech_plot_d.html"),
  selfcontained = TRUE
)
...
saveWidget(
  fig_e,
  paste0(output_dir, "cost_plots/tech_plot_e.html"),
  selfcontained = TRUE
)
